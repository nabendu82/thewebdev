...
slug: interview-preparation-react-1
...
```
The link for the same in JSfiddle is [here](https://jsfiddle.net/nabendu/fyLz9qg1/?utm_source=website&utm_medium=embed&utm_campaign=fyLz9qg1)
