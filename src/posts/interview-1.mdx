...
slug: interview-preparation-basic-javaScript-1
...
**Question 4-** *What is prototypal inheritance ?*
...
```
**Note**: I have a detailed series on Object and Prototypes. You can find it [here](https://thewebdev.tech/ydkjs-objects-and-prototypes-1).
