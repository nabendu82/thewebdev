...
slug: create-twitch-clone-react-5
image: ./twitch-5.jpeg
date: 2019-05-16
...
![New stream with userId](https://ik.imagekit.io/thewebdev/Twitch-React/5/1_xukEa90mK1.png)*New stream with userId*
...
![Beautiful Buttons](https://ik.imagekit.io/thewebdev/Twitch-React/5/2_uzxVwcyupN.png)*Beautiful Buttons*
...
![The Create Stream button](https://ik.imagekit.io/thewebdev/Twitch-React/5/3_HYhZHN2XJ.png)*The Create Stream button*
...
Next, open the **index.js** file in *src -> actions* folder. Import the history at the top and inside `createStream(), add histoy.push(‘/’).` So, the moment the stream creation is dispatched, we move back to the home page.
...
Next, we will add Edit functionality to our App. This will allow user to edit an Stream. Now, open **StreamList.js** and change the Edit button in `renderAdmin()` to a Link tag.
...
![The StreamEdit component](https://ik.imagekit.io/thewebdev/Twitch-React/5/4_ezhMatJbi.png)*The StreamEdit component*
...
![Title shown](https://ik.imagekit.io/thewebdev/Twitch-React/5/5_L3p_Cs75b.png)*Title shown*
...
![Editing a stream](https://ik.imagekit.io/thewebdev/Twitch-React/5/6_B0a8mQ-XtJ.png)*Editing a stream*
