...
![App.js](https://ik.imagekit.io/thewebdev/SpaceX/5/1_IUOWTkgrKu.png)*App.js*

Next, we will create **Rocket.js** inside the **components** folder and put the basic code in it. We will change the content later.

![Rocket.js](https://ik.imagekit.io/thewebdev/SpaceX/5/2_7IiRfDN7wI.png)*Rocket.js*
...
![Rocket.js](https://ik.imagekit.io/thewebdev/SpaceX/5/7_fMTa_HJbHo.png)*Rocket.js*
...
![Rocket.js](https://ik.imagekit.io/thewebdev/SpaceX/5/8_mqA4aoUQGd.png)*Rocket.js*
...
![Rocket Component updated](https://ik.imagekit.io/thewebdev/SpaceX/5/10_tbqrMCqiP7.png)*Rocket Component updated*
